        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              I&apos;m based in Dubai and serve clients across the UAE. Whether
              you&apos;re a resident or non-resident, I can help you navigate
              the UAE mortgage market and find the best financing solutions for
              your needs.
            </p>
